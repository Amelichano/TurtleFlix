...
import { Typography, Card, Input, Button, Select, Option, Alert } from '@material-tailwind/react';
    ...
    <div className="flex h-screen items-center justify-center bg-white p-4">
      ...
      >
        <Card className="w-full max-w-md p-6">
          <Typography className="font-bold mb-6" variant="h4" color="blue-gray">
            TurtleFlix
          </Typography>
          <Input
            type="text"
          ...
          <div className="mt-6 w-full">
            ...
            >
              ...
              {GENRES.map((genre) => (
                <Option value={genre.value} key={genre.key}>{genre.name}</Option>
              ))}
            </Select>
          </div>
